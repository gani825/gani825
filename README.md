...
모르면 그냥 넘어가지 않습니다.
구글링하고, 물어보고, 이해될 때까지 파고드는 개발자입니다.  
👉 [Notion Portfolio](https://fair-busby-5fd.notion.site/Developer-Portfolio-2cff444f601780bda162e2336f813fdb)

---

## 🧑‍💻 Projects

**APTeN** — 모놀리식 아키텍처 기반 스마트 아파트 관리 시스템  
`2026.03.10 ~ 2026.03.26`  
팀장으로 참여해 방문차량 관리, 주차 현황/통계, 관리자 알림 기능을 담당했습니다.  
NOT EXISTS 서브쿼리 기반 주차 현황 조회, JWT/OAuth2 인증 구현 등 백엔드 핵심 기능을 개발했습니다.  
...
프론트엔드 담당으로 백엔드 팀과 API 협업을 처음 경험했습니다.  
소통 과정에서 생기는 데이터 불일치 문제를 직접 조율하며 해결했고,  
지도 마커 커스터마이징을 통해 사용자 경험을 개선했습니다.  
...
React를 처음 사용한 프로젝트로, 낯선 기술 스택을 빠르게 익혀  
캘린더 핵심 기능을 직접 구현했습니다.  
...
![Vue](https://img.shields.io/badge/Vue.js-42B883?style=flat&logo=vuedotjs&logoColor=white)
...
![OAuth2](https://img.shields.io/badge/OAuth2-000000?style=flat)
