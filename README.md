...
**신뢰할 수 있는 코드 · 이해할 수 있는 구조 · 계속 성장하는 개발자**

사용자 경험과 유지보수 가능한 코드를 중요하게 생각하며  
**기능 구현 → 문제 분석 → 개선**까지 이어지는 개발 과정을 좋아합니다.


---

## 🔎 What I Do
- 실제 서비스 구조를 고려한 **프로젝트 설계 & 구현**
- 협업 환경에서의 **역할 분담과 커뮤니케이션**
- 기록과 회고를 통한 **지속적인 성장**
...
## 📂 Portfolio
단순 결과물이 아닌, **기획 → 설계 → 구현 → 개선 과정까지 기록한 실무형 포트폴리오**입니다.  
각 프로젝트별 **역할 / 기여도 / 사용 기술 / 문제 해결 과정**을 확인하실 수 있습니다.
...
- 역할: **캘린더 핵심 기능 및 주요 화면 UI 구현**
- 주요 기능: 운동 일정 관리, 기록 및 시각화
